 ...
 */
public class JPnlLineProperty extends JPnlLineDraggable
{
    static Image img;
    ...
    public JPnlLineProperty(PStatementProperty s, LayoutInfo info)
    {
	super(s, info);
        setOpaque(false);
        if (img == null) {
    ...
    {
	PStatementProperty s = GetStatement();
    ...
    @Override
    public PStatementProperty GetStatement() {return (PStatementProperty)super.GetStatement();}

    @Override
    public JPnlLineProperty clone()
    {
	return new JPnlLineProperty(GetStatement(), m_l);
    }
}
