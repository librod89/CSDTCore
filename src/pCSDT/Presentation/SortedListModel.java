...
public class SortedListModel extends AbstractListModel {
    ...
    class SortedListEntry implements Comparable<SortedListEntry> {
        ...
        public int compareTo(SortedListEntry o) {
            ...
            // compare the base model's elements using PObject's comparator
            
            int comparison = ((PObject)thisElement).drawingOrder - ((PObject)thatElement).drawingOrder;
